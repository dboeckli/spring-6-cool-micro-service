package ch.dboeckli.springframeworkguru.spring6coolmicroservice.log;
...
class ConfigChangeListenerTest {
    ...
    private static final String LOGGER_NAME = "ch.dboeckli.springframeworkguru.spring6coolmicroservice.log.ConfigChangeListener";
